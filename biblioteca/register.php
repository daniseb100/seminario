  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Registro datos personales</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <form id="form-registro">
            <h3 class="text-center w-100">&nbsp; Datos Personales </h3>
             ...
             <div class="row w-100 py-3 text-center">
                 <center><button type="submit" name="butper1" id="butper1" class="btn btn-success" onclick="opc1()">Opcion 1</button>
               <button type="button" name="butper2" id="butper3" class="btn btn-outline-primary w-25" onclick="opc2()">Opcion 2</button>
               <button type="button" name="butper3" id="butper3" class="btn btn-outline-primary w-25" onclick="opc3()">Opcion 3</button></center>  
            </div>
